...
export default class DeleteUnusedEntriesJSPlugin implements WebpackPluginInstance {
    constructor(private entriesToDelete: string[] = []) { }
    apply(compiler: Compiler): void {
        const deleteEntries = (compilation: Compilation) => {
