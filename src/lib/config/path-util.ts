 ...
 * @returns
 */
export function getContentBase(webpackConfig: WebpackConfig): string {
 ...
 * @returns
 */
export function getRelativeOutputPath(webpackConfig: WebpackConfig): string {
 ...
 * @param webpackConfig -
 */
export function validatePublicPathAndManifestKeyPrefix(webpackConfig: WebpackConfig): void {
    ...
    let outputPath: string | null | undefined = webpackConfig.outputPath;
     ...
     */
    if (publicPath && !outputPath?.includes(publicPath)) {
 ...
 * @returns
 */
export function calculateDevServerUrl(runtimeConfig: RuntimeConfig): string {
